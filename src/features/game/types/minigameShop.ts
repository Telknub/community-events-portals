...
export type EasterShopItemName =
  EasterShopCollectibleName | EasterShopWearableName;

export type FestivalOfColorsShopItemName =
  FestivalOfColorsShopCollectibleName | FestivalOfColorsShopWearableName;

export type HalloweenShopItemName =
  HalloweenShopCollectibleName | HalloweenShopWearableName;

export type HolidayShopItemName =
  HolidayShopCollectibleName | HolidayShopWearableName;

export type AprilFoolsShopItemName =
  AprilFoolsShopCollectibleName | AprilFoolsShopWearableName;

export type Colors2026ShopItemName =
  Colors2026ShopCollectibleName | Colors2026ShopWearableName;
...
export const COLORS_2026_STORE: MinigameShop<Colors2026ShopItemName> = {
  ...
  "Rainbow Pork Jelly": {
    cost: { sfl: 0, items: { "Pork Jelly": 1, "Colors Token 2026": 400 } },
    max: 2,
    type: "collectible",
