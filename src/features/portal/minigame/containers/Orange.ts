...
export class Orange extends Phaser.GameObjects.Container {
    ...
    constructor({ x, y, scene, angle, enemies }: Props) {
        ...
        this.sprite = this.scene.add.sprite(0, 0, "orange").setScale(ORANGE_SCALE);
        ...
        body.setCircle(this.sprite.width * ORANGE_SCALE / 2);

        body.setOffset(-this.sprite.width * ORANGE_SCALE / 2, -this.sprite.height * ORANGE_SCALE / 2);
